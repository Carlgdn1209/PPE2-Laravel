    ...
    <body> 
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark" aria-label="">
            <div class="container-fluid serif">
                ...
                <div class="collapse navbar-collapse" id="navbarsExample05">
                    ...
                    <ul class="navbar-nav  mb-2 ">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown" aria-expanded="false">RÃ©servation</a>
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="{{route('r-saisirReservation')}}">Effectuer une rÃ©servation</a></li>
                                <li><a class="dropdown-item" href="{{route('r-consulterLesReservations')}}">Consulter vos rÃ©servations</a></li>
                                <li><a class="dropdown-item" href="#">Rechercher une rÃ©servation</a></li>
                            </ul>
                        </li>
                        <li class="nav-item dropdown">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="#">Nombre de rÃ©servations (par mois)</a></li>
                                <li><a class="dropdown-item" href="#">RÃ©partition gÃ©ographique (par lieu de mise Ã  disposition)</a></li>
                            </ul>
                        </li>
                ...
                <div class="me-3 ">
                    <a class="btn btn-primary btn-sm" href="{{route('r-deconnexion')}}" role="button">DÃ©connexion</a>
